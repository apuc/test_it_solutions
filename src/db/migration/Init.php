...
namespace Kavlar\TestItSolutions\db\migration;

use Kavlar\TestItSolutions\db\DB;
use PDO;
...
class Init
{
    ...
    {
        $this->conn = DB::getInstance()->get_connect();
    }
    ...
    CREATE TABLE IF NOT EXISTS transactions (
        ...
        $this->conn->exec("DELETE FROM `user_accounts`");
